  ...
  return (
    <div>
            ...
            <div className="flex flex-col lg:flex-row">
              <div className="lg:flex lg:w-1/3">
                <p className="text-sm text-gray-500">
                  Desa Benteng, PO BOX 1, Kab. Purwakarta, Provinsi Jawa Barat
                  Indonesia, Kode Pos: 41181
                </p>
              </div>
              ...
              <div className="flex flex-col lg:flex-col lg: w-1/3">
                ...
                <p className="text-sm text-gray-500">+62 22 3000 2019</p>
              </div>
              <div className="lg: w-1/3">
                <p className="text-sm pb-3 text-gray-500">info@panahmerah.id</p>
              </div>
            </div>
          </div>
      ...
      <section>
        <div className="flex flex-col lg:flex-row lg:justify-between">
          ...
          <div className="flex w-full items-center justify-center py-5 gap-5 lg:justify-end lg:pr-24 lg:w-1/2">
            {/* Facebook */}
            <Link
              href="https://web.facebook.com/CapPanahMerah?_rdc=1&_rdr"
              target="blank"
              className="w-9 h-9 mr-3 rounded-full flex justify-center items-center"
            >
              <div className="bg-red-500 rounded-full p-2 hover:border-green-600 hover:bg-green-600 hover:text-white">
                <svg
                  role="img"
                  width="25"
                  className="fill-current text-white z-10"
                  viewBox="0 0 24 24"
            ...
            {/* Linked in */}
            <Link
              href="https://www.linkedin.com/company/pt-east-west-seed-indonesia/"
              target="blank"
              className="w-9 h-9 mr-3 rounded-full flex justify-center items-center"
            >
              <div className="bg-red-500 rounded-full p-2 hover:border-green-600 hover:bg-green-600 hover:text-white">
            ...
            {/* Twitter */}
            <Link
              href="https://twitter.com/cappanahmerah"
              target="blank"
              className="w-9 h-9 mr-3 rounded-full flex justify-center items-center"
            >
              <div className="bg-red-500 rounded-full p-2 hover:border-green-600 hover:bg-green-600">
                <svg
                  role="img"
                  width="25"
                  className="fill-current text-white z-10"
            ...
            {/* Youtube */}
            <Link
              href="https://www.youtube.com/c/PANAHMERAHTV"
              target="blank"
              className="w-9 h-9 mr-3 rounded-full flex justify-center items-center"
            >
              <div className="bg-red-500 rounded-full p-2 hover:border-green-600 hover:bg-green-600">
            ...
            {/* Intagram */}
            <Link
              href="https://www.instagram.com/cappanahmerah/"
              target="blank"
              className="w-9 h-9 mr-3 rounded-full flex justify-center items-center"
            >
              <div className="bg-red-500 rounded-full p-2 hover:border-green-600 hover:bg-green-600">
      ...
      <section className="w-full">
        <div className="bg-slate-100 h-12 p-3">
          <div className="flex justify-center items-center">
            <p className="text-sm">
              Copyright © 2024 PT East West Seed Indonesia
            </p>
          </div>
        </div>
      </section>
